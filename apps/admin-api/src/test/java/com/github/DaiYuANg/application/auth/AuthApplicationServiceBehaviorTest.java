...
import com.github.DaiYuANg.security.AuthenticatedUser;
import com.github.DaiYuANg.security.AuthenticationResult;
...
class AuthApplicationServiceBehaviorTest {
  ...
  void refreshRevokesOldTokenBeforeIssuingNewToken() {
    ...
    var viewMapper = mock(ViewMapper.class);
