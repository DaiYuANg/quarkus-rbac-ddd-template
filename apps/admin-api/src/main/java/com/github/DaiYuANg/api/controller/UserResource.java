...
public class UserResource {
    ...
    @GET @PermissionsAllowed("user:view")
    ...
    @POST @Path("/assign/role") @PermissionsAllowed("user:edit")
    ...
    @PUT @Path("/{id}/status") @PermissionsAllowed("user:edit") public Result<Void> updateUserStatus(@PathParam("id") Long id, @QueryParam("status") Integer status) { userApplicationService.updateUserStatus(id, status); return Result.ok(); }
