package com.liangdian.application.user;

import com.liangdian.accesscontrol.repository.RoleRepository;
import com.liangdian.api.dto.request.UpdateUserForm;
import com.liangdian.api.dto.request.UserCreationForm;
import com.liangdian.api.dto.request.UserRefRoleForm;
...
import com.liangdian.identity.query.UserQueryRepository;
import com.liangdian.identity.repository.UserRepository;
import com.liangdian.security.AuthorizationService;
import com.liangdian.security.CurrentUserAccess;
import com.liangdian.security.PasswordHasher;
...
public class UserApplicationService {
    ...
    public void updateUserPassword(Long id, String newPassword) {
        ...
        var currentUsername = currentUserAccess.currentUser().map(com.liangdian.security.CurrentAuthenticatedUser::username).orElse(null);
