...
/**
 * Maps entity property names (from JPA metamodel) to QueryDSL sort expressions. Use Hibernate
 * Processor metamodel {@code Entity_.field.getName()} for keys to avoid string typos.
 */
@FunctionalInterface
