...
import com.liangdian.identity.entity.SysUser_;
...
public class MetamodelUserQueryBuilder {
    private static final Map<String, MetamodelSortMapping> SORT_MAPPING = Map.of(
        ...
        "mobilePhone", new MetamodelSortMapping("mobilePhone", SysUser_.mobilePhone, SortDirection.ASC),
        "latestSignIn", new MetamodelSortMapping("latestSignIn", SysUser_.latestSignIn, SortDirection.DESC),
    ...
    private List<QuerySort> resolveSorts(UserQuery query) {
        return MetamodelSorts.resolve(query.getSortBy(), query.getSortDirection(), SORT_MAPPING, QuerySort.desc("id"));
    }
