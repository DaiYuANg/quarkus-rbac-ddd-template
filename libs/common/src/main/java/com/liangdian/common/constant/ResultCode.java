package com.liangdian.common.constant;
...
public enum ResultCode {
    ...
    USERNAME_OR_PASSWORD_INVALID("A0210", "username or password invalid", Response.Status.UNAUTHORIZED),
    ...
    ACCOUNT_TEMPORARILY_LOCKED("A0211", "account temporarily locked", Response.Status.TOO_MANY_REQUESTS),
