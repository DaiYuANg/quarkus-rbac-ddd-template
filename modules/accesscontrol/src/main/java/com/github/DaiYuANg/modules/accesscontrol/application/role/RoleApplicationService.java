...
public class RoleApplicationService {
    ...
    public PageResult<RoleVO> queryRolePage(RoleQuery query) {
        ...
        return PageResult.of(slice.total(), query.getPageNum(), query.getPageSize(), slice.content().stream().map(this::toRoleVO).toList());
    }
    ...
    @Transactional
    public void deleteRole(Long id) { authorizationService.check("role", "delete"); roleRepository.deleteById(id); auditSupport.bumpGlobalVersion(); auditSupport.record("role", "delete", String.valueOf(id), true, "delete role"); }
    ...
    public void assignPermissionGroups(RoleRefPermissionGroupForm form) {
        ...
        auditSupport.bumpGlobalVersion();
        auditSupport.record("role", "assign-permission-group", String.valueOf(form.roleId()), true, "assign permission groups");
    }
